...
module CssSanitize
  ...
  def sanitize_css(text)
    ...
    evil = [
      ...
      /behaviou?r|expression|moz-binding|@charset|(java|vb)?script|[\<]|\\\w/i,
      /[\<>]/, # back slash, html tags,
      /[\x7f-\xff]/, # high bytes -- suspect
      /[\x00-\x08\x0B\x0C\x0E-\x1F]/, #low bytes -- suspect
      /&\#/, # bad charset
    ]
    evil << /@import/ unless allow_css_import_statment?
  ...
  # Should '@import' css statements be allowed?
  def allow_css_import_statment?
    false
  end
end
